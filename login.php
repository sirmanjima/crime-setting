...
<body>
	<div class="container" id="wrapper">
		<div id="header">
			 <div class="logo" style="margin-top:-40px;margin-bottom:8px;"><img src="images/lg.jpg" width="60px" height="50px"/>भारत सरकार |<span>| GOVERNMENT OF INDIA</span></div>
		</div>
...
<div class="row" >
	 <div class="col-sm-3"></div>
				<div class="col-sm-9">
        <div id="heading">
            <h3>&nbsp; <span style="margin-bottom:20px; position:relative;">Login</span></h3>
