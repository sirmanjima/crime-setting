              ...
              <form class="bs-example form-horizontal" method="post" action="" id="report_crime" >
                ...
                <fieldset>
                  ...
                  <h3>Specify Location</h3>
                   <div class="form-group">
                    <label for="county" class="col-lg-2 control-label">Address</label>
                    <div class="col-lg-7">
                       <input class="form-control" id="county" placeholder="Address" type="text" required  name="county">
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="category" class="col-lg-2 control-label">Street 1</label>
                    <div class="col-lg-7">
                       <input class="form-control" id="sub_county" placeholder="Street 1" type="text"  required name="sub_county">
                    </div>
                  </div>
				  </td><td width="50%">
                  <div class="form-group">
                    <label for="street" class="col-lg-2 control-label">Street 2</label>
                    <div class="col-lg-7">
                      <input class="form-control" id="street" placeholder="Street 2" type="text"  required name="street">
